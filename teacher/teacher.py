...
# List of teachers
teacher_list = [
    ("08936058-e39e-4acb-9b50-cb6edf262df5", "Niru Gurung"),
    ("0b24bce8-2c6e-43c1-8a45-0788c6470c83", "Khum Sagar Bhandari"),
    ("13f14cf6-1cd6-4437-815f-a61d037c336e", "Usha Paudel"),
    ...
    ("4dce5aba-52d6-47e9-8659-b633b0cdfe33", "Juwa Shahi"),
    ...
    ("8b8ecec4-6c2e-4859-8a0d-6a1bd2e76291", "Nanda Subedi"),
    ("9a31d6b7-5358-4268-b365-483c0c6b2a6e", "Hikmat Soni"),
    ("d09004f0-e3c1-4701-959c-329b8887f7f3", "Chandra Gurung"),
    ("d622c5e5-b21e-49cc-b296-4bfd62e85531", "Sirjana Sawad"),
    ("e5d73dc4-61ed-496e-9aef-a207fa75cc15", "Sudha Acharya"),
    ("e6883468-4226-4d2b-9b2a-11dfb822fb51", "Tapendra Bohora"),
    ("ee193e19-1698-456f-9a87-edae6568ddda", "Pramila Khatri"),
]
